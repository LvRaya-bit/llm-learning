...
from get_order_status import get_order_status  # 替换掉原来的模拟字典
from load_knowledge_from_file import load_knowledge_from_file  # 加载知识库
...
#     """真正执行订单查询的函数"""
#     return company_db.get(order_id, f"未找到订单{order_id}")
